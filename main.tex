...
%
\begin{abstract}
%\input{abstract}  % Put the text for the abstract in a file called "abstract.tex", and it will be inserted here.
\end{abstract}
...
\label{chp:intro}
\input{intro}  % Inserts content from "introduction.tex" here
...
\label{apx:reproj}
\input{appendix-reproj}  % inserts content from "appendix-name.tex"
